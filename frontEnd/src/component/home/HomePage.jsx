        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="" alt="JK Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="jk-color">JK Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="jk-color">JK Hotel</span></h2>
