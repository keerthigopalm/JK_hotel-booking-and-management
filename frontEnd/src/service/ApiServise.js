...
export default class ApiService{
   ...
   /* This get all available rooms by dates from the database with a given data and a room type */
   ...
   /* This get all rooms from the database */
   static async getAllRooms(){
    const result = await axios.get(`${this.BASE_URL}/rooms/all`)
    return result.data
   }

   /* This funtion gets a room By he id */
   static async getRoomById(roomId){
    const result = await axios.get(`${this.BASE_URL}/rooms/room-by-id/${roomId}`)
    return result.data
   }

   /* This delete a room by the id */
   ...
   /**BOOKING */
   /* This saves a new booking to the datebase */
